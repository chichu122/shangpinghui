...
// 获取用户信息【需要带着用户的token向服务器要用户信息】,但api文档中没有说明需要参数，这里的参数通过请求头带过去
...
export const reqSubmitOrder = (tradeNo,data)=>requests({url:`/order/auth/submitOrder?tradeNo=${tradeNo}`,data,method:'get'})