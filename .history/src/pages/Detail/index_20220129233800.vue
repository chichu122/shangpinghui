  ...
  methods:{
    ...
    addShopcar(){
      ...
      /* 当前这里是派发一个action，也向服务器发请求，判断购物车是否加入成功，进行相应操作
         ...
         这代码是在调用仓库中addOrUpdateShopCart，这个方法加上async，返回一定是一个promise
         要么成功要么失败
      */
      let result = athis.$store.dispatch('addOrUpdateShopCart',{skuId:this.$route.params.skuid , skuNum:this.skuNum})
